...
class __TwigTemplate_59d1d97cd13c088e5adec3b9278ae44f extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Open the two-factor authentication app on your device to view your authentication code and verify your identity.");
    ...
    {
        return new Source("", "login/twofactor/application.twig", "/var/www/pterodactyl/public/phpmyadmin/templates/login/twofactor/application.twig");
    }
}
