...
class __TwigTemplate_2ad9acce5c2167a1be8f8a27cab6c348 extends Template
{
    private $source;
    private $macros = [];
...
($context["servers"] ?? null), "select", [], "any", false, false, false, 35)]));
    ...
    {
        return new Source("", "server/select/index.twig", "/var/www/pterodactyl/public/phpmyadmin/templates/server/select/index.twig");
    }
}
